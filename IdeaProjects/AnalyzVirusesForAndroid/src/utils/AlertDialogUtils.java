...
public class AlertDialogUtils {
    ...
    private static final String LOGGING = "Логирование";
    private static final String LOGGING_STOP = "Ведется сбор логов";
    ...
    public static void showLoggingDialog(Process process) throws IOException, InterruptedException, ParseException, NoSuchFieldException, IllegalAccessException {
        ...
        if (click.get() == stop) {
            ...
            JSONParserUtils.createJsonFile(process);
        }
    }
}
